...
#     Evenement, Contact, Communaute, Rapport, Message, ResponseMessage,
#     Participate, Prediction, Notification, Collaboration
# )
# from .serializer import (
#     UserSerializer, CategorySerializer, IncidentSerializer,
#     ZoneSerializer, EluToZoneSerializer
# )
# from .views import (
...
#         communaute = Communaute.objects.create(name="Test Community", zone=self.zone)
